# The content for this script comes from a github repo dedicated to quest information for the official Everquest Emulator project located at https://github.com/ProjectEQ/projecteqquests
# clone or download this repo and place the projecteqquests-master folder in the /data directory of this project, then run this script:
...
db_path = os.path.join(root_dir, "data", "db", "eq_data.db")
...
quests_dir = os.path.join(script_dir, "..", "projecteqquests-master")
...
def read_file(file_path):
    ...
    for encoding in encodings:
        try:
            ...
            continue
    raise ValueError(
        f"Unable to read file {file_path} with any of the attempted encodings"
    )
